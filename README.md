...
## ขอบเขตที่บันทึกไว้ช่วง Round 5B (ข้อมูลย้อนหลัง)

รายการส่วนนี้และแผนท้ายเอกสารเป็นบันทึกช่วงต้น ไม่ใช่สถานะล่าสุด หลังจากนั้นมี Quiz Engine ข้อกา/ตัวเลข/ลากวาง สมุดบันทึกในเครื่อง และโค้ด Classroom เพิ่มแล้ว ดูขั้นตอนเพิ่มเนื้อหาปัจจุบันใน [START-HERE.txt](START-HERE.txt) และผลตรวจหลังย้ายใน [MIGRATION.md](MIGRATION.md) การทดสอบบริการจริงยังแยกจากผลทดสอบจำลอง
...
## ลำดับงานที่บันทึกไว้ช่วงแรก

สถานะ ณ Round 5B: **มี Content HTML Contract, Activity Core และ Print Core กลางแล้ว โดยยังไม่ตรวจคะแนนในรอบนั้น**
...
## แบบ Navigation และแผนเดิม (ข้อมูลย้อนหลัง)
